...
exports.createCourse=async(req,res)=>{
    ...
    const categoryDetails = await Category.findById(category.trim());
    if (!categoryDetails) {
        return res.status(404).json({
            success: false,
   ...
   //Upload thumbnaill to cloudinary
...
exports.getInstructorCourses = async (req, res) => {
  ...
  exports.deleteCourse=async(req,res)=>{
    try{
        ...
        return res.status(500).json({
            success:false,
            message:"Course deletion Server error",
            error:error.message
        })
  ...
  //     const courseContent = Array.isArray(courseDetails.courseContent)
  ...
  //           subSection && subSection.timeDuration ? subSection.timeDuration : 0,
  //           10
  //         )
